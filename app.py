...
log_reg_model = joblib.load('model/logistic_regression_model_8.pkl')
...
with st.form("input_form"):
    ...
    NAF = st.number_input("Cantidad de folículos aspirados", min_value=0, max_value=1000, value=0)
...
if submit_button:
    ...
    input_data = pd.DataFrame({
        '9 Edad paciente': [age],
        '38 Cantidad de folículos aspirados': [NAF],
        'IMC': [IMC],
        '25 CFA': [CFA],
        '26 HAM': [HAM],
    ...
    numeric_cols = ['9 Edad paciente', 'IMC', '25 CFA', '26 HAM', '38 Cantidad de folículos aspirados']
    ...
    input_data = input_data[['9 Edad paciente', 'IMC', '25 CFA', '26 HAM', '38 Cantidad de folículos aspirados','Hijos Previos', 'Fuma']]    
